 ...
 * Use the {@link MyTeamsFragment#newInstance} factory method to
...
Button ParticularTeam;
     ...
     * @return A new instance of fragment MyTeamsFragment.
     */
...
//MainActivity mainActivity = (MainActivity) getActivity();
       ParticularTeam = view.findViewById(R.id.btnNavParticularTeams);
        ...
        ParticularTeam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentTransaction.replace(R.id.nav_host_fragment, new ParticularTeamFragment());
